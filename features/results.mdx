...
Survey results include both individual persona responses and aggregate data, helping you understand consensus views and identify outliers in your artificial society.

In the results panel, you'll find a detailed response breakdown, showing the choice percentage of each option. Clicking on this tile displays the choices for every persona in the network, and you can click on each persona individually to see their thoughts and ask follow-up questions.
