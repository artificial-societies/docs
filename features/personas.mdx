...
<Accordion title="What about characteristics that aren't publicly visible?">
    Our data allows us to infer many audience characteristics, such as political beliefs and opinions. However, when you create a target society requiring specific attributes that aren't easily observable - like being interested in life insurance or owning a Tesla - we can add these characteristics to personas within your audience.
</Accordion>
