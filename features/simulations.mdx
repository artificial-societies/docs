...
<Steps>
    ...
    After choosing your content type, draft the message you want to test. For example, if you're simulating a LinkedIn post, write the post as you would normally share it. Unlike a chatbot, where you might ask a question, here you’re crafting the actual content to be evaluated by the personas.
