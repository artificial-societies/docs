...
description: 'Get up and running with Artificial Societies in three simple steps'
icon: 'rocket'
---
...
<Steps>
    ...
    <span role="img" aria-label="lightbulb">💡</span> You can return to the Societies Homepage at any time by clicking the name of the society in the top left corner of the app.
